...
export const mockNotificationLogs: NotificationLog[] = [
  {
    ...
    updatedAt: "2026-02-21T10:30:01Z",
    retryHistory: [],
  },
  {
    id: "log-002",
    ...
    retryCount: 0,
    deliveryTimeMs: 85,
    createdAt: "2026-02-21T10:28:00Z",
    updatedAt: "2026-02-21T10:28:00Z",
    retryHistory: [],
  },
  {
    id: "log-003",
    ...
    payload: { messageId: "msg-789", sender: "Sarah" },
    errorMessage: "Device token expired",
    retryCount: 3,
    createdAt: "2026-02-21T10:25:00Z",
    updatedAt: "2026-02-21T10:26:30Z",
    retryHistory: [
  ...
  },
  {
    ...
    updatedAt: "2026-02-21T10:20:05Z",
    retryHistory: [
  ...
  },
  {
    ...
    updatedAt: "2026-02-21T10:15:03Z",
    retryHistory: [
  ...
  },
  {
    ...
    channel: "PUSH",
    status: "DELIVERED",
    recipient: "device-token-def",
    subject: "Flash Sale!",
    payload: { saleId: "sale-42", discount: "30%" },
    retryCount: 0,
    deliveryTimeMs: 65,
  ...
  },
  {
    ...
    updatedAt: "2026-02-21T10:06:30Z",
    retryHistory: [
  ...
  },
  {
    ...
    templateId: "tmpl-005",
    payload: { reportId: "rpt-100" },
    retryCount: 0,
    createdAt: "2026-02-21T10:31:00Z",
    updatedAt: "2026-02-21T10:31:00Z",
    retryHistory: [],
  },
];
...
export const mockDlqItems: FailedNotification[] = [
  {
    ...
    createdAt: "2026-02-21T10:06:30Z",
    lastRetryAt: "2026-02-21T10:06:30Z",
  },
  {
    id: "dlq-002",
    ...
    errorMessage: "Twilio: Invalid phone number format",
    retryCount: 4,
    isUnrecoverable: false,
    createdAt: "2026-02-21T09:50:00Z",
    lastRetryAt: "2026-02-21T09:52:00Z",
  },
  {
    id: "dlq-003",
    ...
    userId: "user-009",
    channel: "PUSH",
    recipient: "expired-token-xyz",
    subject: "You have a new follower",
    payload: { followerId: "user-100" },
    errorCode: "DEVICE_UNREGISTERED",
    errorMessage: "Push token is no longer valid",
    retryCount: 4,
    isUnrecoverable: true,
    createdAt: "2026-02-20T18:00:00Z",
    lastRetryAt: "2026-02-20T18:05:00Z",
  },
  {
    id: "dlq-004",
    ...
    userId: "user-010",
    channel: "EMAIL",
    recipient: "bob@nonexistent-domain.xyz",
    subject: "Invoice #5678",
    payload: { invoiceId: "5678", amount: "$120.00" },
    errorCode: "DNS_RESOLUTION_FAILED",
    errorMessage: "Could not resolve MX record for domain",
    retryCount: 4,
    isUnrecoverable: false,
    createdAt: "2026-02-20T14:30:00Z",
    lastRetryAt: "2026-02-20T14:33:00Z",
  },
  {
    id: "dlq-005",
    ...
    errorMessage: "Provider rate limit exceeded for destination",
    retryCount: 4,
    isUnrecoverable: false,
    createdAt: "2026-02-19T22:15:00Z",
    lastRetryAt: "2026-02-19T22:20:00Z",
  },
];
...
export const mockTemplates: NotificationTemplate[] = [
  ...
  },
  {
    ...
    status: "PUBLISHED",
    version: 1,
    variables: ["name", "resetLink", "expiry"],
  ...
  },
  {
    ...
    status: "DRAFT",
    version: 1,
    variables: ["weekRange", "totalSent", "successRate"],
...
export const mockApiKeys: ApiKey[] = [
  {
    ...
    keyPrefix: "nfy_prod_a1b2",
    status: "ACTIVE",
    createdAt: "2026-01-01T00:00:00Z",
    lastUsedAt: "2026-02-21T10:30:00Z",
    expiresAt: "2027-01-01T00:00:00Z",
    totalRequests: 184293,
  },
  {
    id: "key-002",
    name: "Staging API Key",
    keyPrefix: "nfy_stg_c3d4",
    status: "ACTIVE",
    createdAt: "2026-01-15T00:00:00Z",
    lastUsedAt: "2026-02-20T18:00:00Z",
    totalRequests: 42819,
  },
  {
    id: "key-003",
    name: "Development Key",
    keyPrefix: "nfy_dev_e5f6",
    status: "ACTIVE",
    createdAt: "2026-02-01T00:00:00Z",
    lastUsedAt: "2026-02-21T09:00:00Z",
    totalRequests: 8912,
  },
  {
    id: "key-004",
    name: "Legacy Service Key",
    keyPrefix: "nfy_leg_g7h8",
    status: "REVOKED",
    createdAt: "2025-06-01T00:00:00Z",
    lastUsedAt: "2025-12-15T00:00:00Z",
    totalRequests: 291034,
  },
];
